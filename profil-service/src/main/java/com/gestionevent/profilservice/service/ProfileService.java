...
import com.gestionevent.profilservice.repository.ProfileRepository;
...
public class ProfileService {
    ...
    private final com.gestionevent.profilservice.repository.ProfileImageRepository profileImageRepository;

    private static final String HISTORY_INSCRITS = "inscrits";
    private static final String HISTORY_CREES = "créés";

    public ProfileService(ProfileRepository profileRepository,
            com.gestionevent.profilservice.repository.ProfileImageRepository profileImageRepository) {
    ...
    public void uploadProfileImage(Long userId, org.springframework.web.multipart.MultipartFile file)
        ...
        if (profileOpt.isPresent()) {
            ...
            Optional<com.gestionevent.profilservice.entity.ProfileImage> existingImage = profileImageRepository
                    .findByProfileId(profile.getId());

            com.gestionevent.profilservice.entity.ProfileImage image;
            if (existingImage.isPresent()) {
                image = existingImage.get();
                image.setImageData(file.getBytes());
                image.setContentType(file.getContentType());
            } else {
                image = new com.gestionevent.profilservice.entity.ProfileImage(profile.getId(), file.getBytes(),
                        file.getContentType());
            }
    ...
    public Optional<com.gestionevent.profilservice.entity.ProfileImage> getProfileImage(Long profileId) {

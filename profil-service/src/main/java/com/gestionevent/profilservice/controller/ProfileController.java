package com.gestionevent.profilservice.controller;

import com.gestionevent.profilservice.entity.Profile;
import com.gestionevent.profilservice.service.KafkaTest;
import com.gestionevent.profilservice.service.ProfileService;
...
public class ProfileController {
    ...
    public ResponseEntity<byte[]> getImage(@PathVariable Long userId) {
        ...
        java.util.Optional<com.gestionevent.profilservice.entity.Profile> profile = profileService
                .getProfileByUserId(userId);
        if (profile.isPresent()) {
            java.util.Optional<com.gestionevent.profilservice.entity.ProfileImage> imageOpt = profileService
                    .getProfileImage(profile.get().getId());
            if (imageOpt.isPresent()) {
                com.gestionevent.profilservice.entity.ProfileImage image = imageOpt.get();

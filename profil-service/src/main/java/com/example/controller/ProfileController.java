...
public class ProfileController {
    ...
    // GET /profiles/user/{userId} -> Récupérer par l'ID global (Création auto si absent)
    @GetMapping("/user/{userId}")
    public ResponseEntity<?> getProfileByUserId(@PathVariable Long userId) {
        System.out.println("🚀 [DEBUG] Received request for User ID: " + userId);
        Profile profile = profileService.getOrCreateProfileByUserId(userId);
